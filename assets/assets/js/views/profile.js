    ...
    window.StopIt.Views.ProfileView = class ProfileView {
        ...
        attachEventListeners(container) {
            ...
            container.querySelector('#save-settings').addEventListener('click', async () => {
                ...
                window.StopIt.Utils.Notifications.show('Impostazioni salvate! ✅', 'success');
            });
            ...
            container.querySelector('#btn-export').addEventListener('click', async () => {
                try {
                    ...
                    window.StopIt.Utils.Notifications.show('Backup scaricato con successo! ✅', 'success');
                } catch (e) {
                    window.StopIt.Utils.Notifications.show('Errore export: ' + e.message, 'error');
                }
            });
            ...
            container.querySelector('#btn-delete-account').addEventListener('click', async () => {
                ...
                window.StopIt.Utils.Modals.confirm(
                    'Elimina Account',
                    `ATTENZIONE: Stai per eliminare definitivamente l'account "${username}" e tutti i tuoi progressi.\nQuesta azione è irreversibile.\n\nSei sicura?`,
                    async () => {
